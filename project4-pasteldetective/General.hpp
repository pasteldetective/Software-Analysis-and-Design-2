 ...
 * @file Network.hpp
 * @author Jackie Yee
 * @brief Project 4: General.hpp
 * @version 0.5
 * @date 2022-10-25
 * 
 * General.hpp includes the General class private and public members
 **/
...
class General : public Post {
    ...
    public:
      ...
      */
       ...
       //Project 4 changed to const override
        void displayPost() const override;                 //Function used to display Post
