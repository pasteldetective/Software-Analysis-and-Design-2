 ...
 * @file Network.hpp
 * @author Jackie Yee
 * @brief Project 4: Poll.hpp
 * @version 0.5
 * @date 2022-10-25
 * 
 *Poll header file includes Poll class constructors destructor and private and public member
 **/
...
class Poll :public Post {
    public:
      ...
      */
       ...
       //project 4 const override to prevent changes
