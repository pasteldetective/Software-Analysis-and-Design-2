...
/*
    ...
    Comparing two nodes using swap
*/
template <typename ItemType>
template <typename Comparator>
LinkedList<Post*> Network<ItemType>::bSortByUsername(Comparator comparing, int *incremental)
{
    LinkedList<Post*> copy = feed_; //set LinkedList copy to feed_
    copy.bubbleSort(comparing,incremental); //then sorts the feed_
    return copy; //return copy
}

/*
template <typename ItemType>
template <typename Comparator>//two para same type, return a bool
void Network<ItemType>::swapBetweenNodes(Comparator comparing,int *incremental)
{
    
//var pointing to node in linkedlist head pointer and incrementing thorugh as acounter u
